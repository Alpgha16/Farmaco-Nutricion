...
<form action="/interaccion/editar" method="post" class="container mt-5">
    @csrf
    <div class="input-group mb-3" style="visibility: hidden;">
        ...
        <input type="text" id="disabledTextInput" class="form-control" value="<?php echo $mostrar['id_inter'] ?>" name="inter">
    </div>
    <fieldset disabled>
    ...
    <div class="form-floating mb-3">
        <input type="text" class="form-control" id="floatingInput" name="recomendacion" value="<?php echo $mostrar['interaccion'] ?>">
    ...
    <tbody>
            ...
            ?>
                ...
                <th scope="row"><?php echo $num;
                    ...
                    <td>
                        <a href="/interaccion/editar/<?php echo $mostrar2['id'] ?>">
